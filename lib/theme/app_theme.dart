...
// Text styles
class AppText {
  static TextStyle fredoka(double size, Color color, {FontWeight weight = FontWeight.normal}) =>
      GoogleFonts.fredoka(fontSize: size, color: color);

  static TextStyle nunito(double size, Color color, {FontWeight weight = FontWeight.w700}) =>
